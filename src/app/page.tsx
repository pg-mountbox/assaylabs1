      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-20">
          ...
          <p className="text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            ...
            and submit specialized test requirements to solve your food industry challenges.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white rounded-2xl p-10 shadow-xl hover:shadow-2xl transition-all duration-300 border-0 group">
            ...
            <h3 className="text-2xl font-display font-bold mb-4 text-gray-900">Specialized Tests</h3>
            <p className="text-gray-600 mb-6 leading-relaxed text-lg">
              Submit specialized test requirements and connect with expert laboratories 
